...
class GenerateNodes extends Command
{
    ...
    public function handle(){
        ...
        if(config('solunes.accounting')){
          $this->info(\FuncNode::load_nodes_excel(base_path(config('solunes.solunes_path').'/accounting/src/nodes.xlsx')));
        }
        ...
        if(config('solunes.staff')){
          $this->info(\FuncNode::load_nodes_excel(base_path(config('solunes.solunes_path').'/staff/src/nodes.xlsx')));
        }
