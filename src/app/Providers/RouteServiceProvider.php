...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected $accountingNamespace = 'Solunes\Accounting\App\Controllers';
    ...
    protected $staffNamespace = 'Solunes\Staff\App\Controllers';
    ...
    protected function mapAdminRoutes(Router $router)
    {
        ...
        if(config('solunes.accounting')){
            $router->group(['namespace' => $this->accountingNamespace, 'middleware' => 'admin'], function ($router) {
                require __DIR__ . '/../../../../accounting/src/app/Routes/admin.php';
            });
        }
        ...
        if(config('solunes.staff')){
            $router->group(['namespace' => $this->staffNamespace, 'middleware' => 'admin'], function ($router) {
                require __DIR__ . '/../../../../staff/src/app/Routes/admin.php';
            });
        }
    ...
    protected function mapWebRoutes(Router $router)
    {
        ...
        if(config('solunes.accounting')){
            $router->group(['namespace' => $this->accountingNamespace, 'middleware' => 'web'], function ($router) {
                require __DIR__ . '/../../../../accounting/src/app/Routes/routes.php';
            });
        }
        if(config('solunes.payments')){
        ...
        if(config('solunes.staff')){
            $router->group(['namespace' => $this->staffNamespace, 'middleware' => 'web'], function ($router) {
                require __DIR__ . '/../../../../staff/src/app/Routes/routes.php';
            });
        }
        if(config('solunes.customer')){
