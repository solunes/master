      ...
      <div class="row main_row">
          ...
          {!! Form::open(array('name' => 'cuenta_password', 'url' => 'account/password', 'class' => 'form-horizontal prevent-double-submit', 'autocomplete' => 'off')) !!}
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">{!! Form::password('password', array('class'=>'form-control', 'placeholder'=>'Contraseña', 'autocomplete'=>'off')) !!}</div>
                  <div class="col-sm-offset-6 col-sm-6 error">{{ $errors->first('password') }}</div>
             </div>
              <div class="form-group">
              	{!! Form::label('password_confirmation', 'Confirmar Contraseña (*)', array('class'=>'col-sm-6 control-label')) !!} 
                  <div class="col-sm-6">{!! Form::password('password_confirmation', array('class'=>'form-control', 'placeholder'=>'Confirmar Contraseña', 'autocomplete'=>'off')) !!}</div>
                  <div class="col-sm-offset-6 col-sm-6 error">{!! $errors->first('password_confirmation') !!}</div>
             </div>
              <div class="form-group">
