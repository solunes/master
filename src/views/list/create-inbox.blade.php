...
@section('content')
<h1 class="page-title"> Crear Conversación | <a href="{{ url('admin/my-inbox') }}">Volver a Bandeja de Entrada</a></h1>

<div class="inbox">
  {!! Form::open(array('name'=>'create-inbox', 'id'=>'create', 'role'=>'form', 'url'=>'admin/create-inbox', 'class'=>'form-horizontal prevent-double-submit', 'autocomplete'=>'off')) !!}
    <div class="row">
      <div class="col-sm-4">
