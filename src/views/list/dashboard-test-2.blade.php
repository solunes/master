            ...
            <div class="card bg-analytics text-white">
                <div class="card-content">
                    <div class="card-body text-center">
                        <img src="{{ asset('assets/admin/img/admin-2/decore-left.png') }}" class="img-left" alt="card-img-left">
                        <img src="{{ asset('assets/admin/img/admin-2/decore-right.png') }}" class="img-right" alt="card-img-right">
                                    ...
                                    <td class="p-1">
                                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Vinnie Mostowy" class="avatar pull-up">
                                                <img class="media-object rounded-circle" src="{{ asset('assets/admin/img/no_picture.jpg') }}" alt="Avatar" height="30" width="30">
                                            </li>
